...
$sql = "SELECT * FROM SAKE_IMAGE WHERE sake_id = '$sake_id' AND contributor = '$contributor'";
...
$sql = "DELETE FROM SAKE_IMAGE WHERE sake_id = '$sake_id' AND contributor = '$contributor'";
